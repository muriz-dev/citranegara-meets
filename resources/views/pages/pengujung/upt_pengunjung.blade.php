...
@section('content')
    <div class="container">
        <div class="">
            <div class="card">
                <div class="card-body">
                    <form action="/acara/{{ $acara }}/pengunjung/{{ $pengunjung->id }}" method="POST" class="form1">
                        @method('PUT')
                        @csrf
                        <input type="hidden" name="kode_acara" value="{{ $acara }}">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Peserta</label>
                            <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap', $pengunjung->nama_lengkap) }}" class="form-control" autocomplete="off">
                            @error('nama_lengkap')
                                {{ $message }}
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="tel" name="telepon" value="{{ old('telepon', $pengunjung->telepon) }}" class="form-control" autocomplete="off">
                            @error('telepon')
                                {{ $message }}
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" value="{{ old('email', $pengunjung->email) }}" class="form-control" autocomplete="off">
                            @error('email')
                                {{ $message }}
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="asal" value="{{ old('asal', $pengunjung->asal) }}" class="form-control">
                            @error('asal')
                                {{ $message }}
                            @enderror
                        </div>
